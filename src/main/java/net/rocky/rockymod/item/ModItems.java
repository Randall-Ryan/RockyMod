...
import net.rocky.rockymod.item.custom.FuelItem;
import net.rocky.rockymod.item.custom.MetalDetectorItem;

public class ModItems {
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, RockyMod.MOD_ID);
